        ...
        <div class="box-wrapper">
            <div class="box box-border">
                <div class="box-body">
                    ...
                    <button  class = "aaa" onclick="location.href='https://kauth.kakao.com/oauth/authorize?client_id=eac6586e062e9e84f8798226d9ac9be8&redirect_uri=http://ec2-52-78-107-113.ap-northeast-2.compute.amazonaws.com/login/kakao/login/kakao&response_type=code'" type="button" id="img_btn">
