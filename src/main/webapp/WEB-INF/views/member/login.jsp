        ...
        <div class="box-wrapper">
            <div class="box box-border">
                <div class="box-body">
                    ...
                    <button  class = "aaa" onclick="location.href='https://kauth.kakao.com/oauth/authorize?client_id=eac6586e062e9e84f8798226d9ac9be8&redirect_uri=http://demo-app-db.c2u8eqkulgut.ap-northeast-1.rds.amazonaws.com/login/kakao&response_type=code'" type="button" id="img_btn">
